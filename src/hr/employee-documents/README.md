...
نظام متكامل لإدارة وثائق الموظفين في DevHouse ERP. يوفر إمكانيات رفع، تخزين، وإدارة جميع المستندات المتعلقة بالموظفين مع تنبيهات ذكية لانتهاء الصلاحية.
...
جزء من DevHouse ERP System - جميع الحقوق محفوظة
