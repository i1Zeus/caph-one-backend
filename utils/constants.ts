...
export const ACCOUNT_TYPE_GROUPS = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: ACCOUNT_TYPES.LIABILITY_NON_CURRENT, label: 'Non-current Liabilities' },
    ]
  },
  {
    label: 'Equity',
    options: [
      ...
      { value: ACCOUNT_TYPES.EQUITY_UNAFFECTED, label: 'Current Year Earnings' },
    ]
  },
  {
    label: 'Profit & Loss',
  ...
  },
  {
    label: 'Other',
    options: [
      { value: ACCOUNT_TYPES.OFF_BALANCE, label: 'Off-Balance Sheet' },
    ]
  }
];

export type AccountTypeValue = typeof ACCOUNT_TYPES[keyof typeof ACCOUNT_TYPES];
