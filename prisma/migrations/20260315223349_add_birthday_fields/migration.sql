...
-- CreateEnum
CREATE TYPE "public"."PropertyType" AS ENUM ('APARTMENT', 'VILLA', 'HOUSE', 'LAND', 'SHOP', 'OFFICE', 'WAREHOUSE', 'BUILDING', 'OPEN_FLOOR', 'FARM', 'OTHER');

-- CreateEnum
CREATE TYPE "public"."PropertyStatus" AS ENUM ('AVAILABLE', 'RESERVED', 'SOLD', 'RENTED', 'UNDER_MAINTENANCE', 'UNAVAILABLE');

-- CreateEnum
CREATE TYPE "public"."OfferStatus" AS ENUM ('PENDING', 'ACCEPTED', 'REJECTED', 'EXPIRED', 'CONVERTED_TO_CONTRACT');

-- CreateEnum
CREATE TYPE "public"."ContractType" AS ENUM ('SALE_PURCHASE', 'RENT_LEASE', 'INVESTMENT');

-- CreateEnum
CREATE TYPE "public"."PropertyRequestType" AS ENUM ('SALE', 'LEASE');

-- CreateEnum
CREATE TYPE "public"."ContractStatus" AS ENUM ('DRAFT', 'ACTIVE', 'COMPLETED', 'CANCELLED', 'EXPIRED');

-- CreateEnum
CREATE TYPE "public"."PropertyGroupFilter" AS ENUM ('SALE', 'RENT');

-- CreateEnum
CREATE TYPE "public"."CityCenterFilter" AS ENUM ('COMMERCIAL_SALES', 'RESIDENTIAL_SALES', 'COMMERCIAL_RENTALS', 'RESIDENTIAL_RENTALS');

-- CreateEnum
CREATE TYPE "public"."EntityType" AS ENUM ('PROPERTY_GROUP', 'CITY_CENTER', 'SPORTS_CITY');

-- CreateEnum
CREATE TYPE "public"."AttachmentFileType" AS ENUM ('IMAGE', 'PDF', 'DOCUMENT', 'OTHER');
...
CREATE TABLE "public"."properties" (
    ...
    "height" DECIMAL(10,2),
    "area" DECIMAL(15,2),
    "builtUpArea" DECIMAL(15,2),
    "gardenArea" DECIMAL(15,2),
    "buildingToLandRatio" DECIMAL(5,2),
    "areaUnit" TEXT DEFAULT 'm²',
    "bedrooms" INTEGER,
    "bathrooms" INTEGER,
    "floors" INTEGER,
    ...
    "soundInsulation" BOOLEAN DEFAULT false,
    ...
    "propertyGroupFilter" "public"."PropertyGroupFilter",
    "cityCenterFilter" "public"."CityCenterFilter",
    "images" TEXT[],
    "documents" TEXT[],
    "features" TEXT,
    "notes" TEXT,
...
-- CreateTable
CREATE TABLE "public"."sports_cities" (
    "id" SERIAL NOT NULL,
    "name" TEXT NOT NULL,
    "description" TEXT,
    "city" TEXT,
    ...
    CONSTRAINT "sports_cities_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "public"."user_entity_accesses" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    ...
    CONSTRAINT "user_entity_accesses_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "public"."property_requests" (
    ...
    "requestType" "public"."PropertyRequestType" NOT NULL,
    "city" TEXT,
    "district" TEXT,
    "address" TEXT,
    "priceMin" DECIMAL(15,2),
    "priceMax" DECIMAL(15,2),
    "lengthMin" DECIMAL(10,2),
    "lengthMax" DECIMAL(10,2),
    "widthMin" DECIMAL(10,2),
    "widthMax" DECIMAL(10,2),
    "heightMin" DECIMAL(10,2),
    "heightMax" DECIMAL(10,2),
    "builtUpAreaMin" DECIMAL(15,2),
    "builtUpAreaMax" DECIMAL(15,2),
    "gardenAreaMin" DECIMAL(15,2),
    "gardenAreaMax" DECIMAL(15,2),
    "bedroomsMin" INTEGER,
    "bedroomsMax" INTEGER,
    ...
    "floorsMin" INTEGER,
    "floorsMax" INTEGER,
    "parkingSpacesMin" INTEGER,
    "parkingSpacesMax" INTEGER,
    "elevatorsMin" INTEGER,
    "elevatorsMax" INTEGER,
    "balconiesMin" INTEGER,
    "balconiesMax" INTEGER,
...
CREATE TABLE "public"."contract_attachments" (
    ...
    "mimetype" TEXT NOT NULL,
    "fileType" "public"."AttachmentFileType" NOT NULL DEFAULT 'DOCUMENT',
    "title" TEXT,
    "description" TEXT,
    "uploadedById" TEXT NOT NULL,
    "isDeleted" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE INDEX "properties_groupId_idx" ON "public"."properties"("groupId");

-- CreateIndex
CREATE INDEX "properties_cityCenterId_idx" ON "public"."properties"("cityCenterId");

-- CreateIndex
CREATE INDEX "properties_sportsCityId_idx" ON "public"."properties"("sportsCityId");

-- CreateIndex
CREATE INDEX "user_entity_accesses_userId_idx" ON "public"."user_entity_accesses"("userId");

-- CreateIndex
CREATE INDEX "user_entity_accesses_entityType_idx" ON "public"."user_entity_accesses"("entityType");

-- CreateIndex
CREATE UNIQUE INDEX "user_entity_accesses_userId_entityType_key" ON "public"."user_entity_accesses"("userId", "entityType");

-- CreateIndex
CREATE INDEX "property_requests_leadId_idx" ON "public"."property_requests"("leadId");

-- CreateIndex
CREATE INDEX "property_requests_status_idx" ON "public"."property_requests"("status");

-- CreateIndex
CREATE INDEX "property_requests_propertyType_idx" ON "public"."property_requests"("propertyType");

-- CreateIndex
CREATE INDEX "property_requests_city_idx" ON "public"."property_requests"("city");

-- CreateIndex
CREATE UNIQUE INDEX "property_contracts_contractNumber_key" ON "public"."property_contracts"("contractNumber");

-- CreateIndex
CREATE INDEX "property_contracts_propertyId_idx" ON "public"."property_contracts"("propertyId");

-- CreateIndex
CREATE INDEX "property_contracts_leadId_idx" ON "public"."property_contracts"("leadId");

-- CreateIndex
CREATE INDEX "property_contracts_status_idx" ON "public"."property_contracts"("status");

-- CreateIndex
CREATE INDEX "property_contracts_contractType_idx" ON "public"."property_contracts"("contractType");

-- CreateIndex
CREATE INDEX "contract_attachments_contractId_idx" ON "public"."contract_attachments"("contractId");

-- CreateIndex
CREATE INDEX "contract_attachments_fileType_idx" ON "public"."contract_attachments"("fileType");

-- CreateIndex
CREATE INDEX "contract_attachments_uploadedById_idx" ON "public"."contract_attachments"("uploadedById");

-- CreateIndex
CREATE INDEX "contract_signatures_contractId_idx" ON "public"."contract_signatures"("contractId");

-- CreateIndex
CREATE INDEX "contract_signatures_signerRole_idx" ON "public"."contract_signatures"("signerRole");
